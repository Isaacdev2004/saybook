...
const plans = [
  {
    ...
    features: ["1 DHM outline", "Multi-chapter structure (up to 5 chapters)", "1 revision", "1 ebook"],
    badge: null,
  ...
  },
  {
    ...
    features: ["3 DHM outlines", "Multi-chapter structure (up to 7 chapters)", "2 revisions", "2 ebooks + 1 course"],
    badge: "Most Popular",
  ...
  },
  {
    ...
    features: [
      "5 DHM outlines",
      "5 reviews",
      "Multi-chapter structure (up to 9 chapters)",
      "All resources",
      "Priority support",
